...
const MissionOpsGrid = () => {
  ...
  return (
    <div className={`h-screen ${theme === 'light' ? 'bg-white text-neutral-900' : 'bg-neutral-950 text-white'} relative overflow-hidden`}>
      {/* Header */}
      <div className={`absolute top-0 left-0 right-0 z-50 ${theme === 'light' ? 'bg-white text-neutral-900' : 'bg-neutral-900/80 border-neutral-700'} backdrop-blur-sm border-b`}>
          ...
          <div className="flex items-center gap-3">
            ...
            {missions.length > 0 && (
              <button
                ...
                className={`p-2 ${theme === 'light' ? 'hover:bg-neutral-100' : 'hover:bg-neutral-700'} rounded-lg transition-colors`}
            ...
            <button className={`p-2 ${theme === 'light' ? 'hover:bg-neutral-100' : 'hover:bg-neutral-700'} rounded-lg transition-colors`}>
      ...
      {/* Legend */}
      <div className={`absolute bottom-4 left-4 ${theme === 'light' ? 'bg-white text-neutral-900' : 'bg-neutral-900/90'} backdrop-blur-sm rounded-lg p-4 text-sm pointer-events-auto`}>
